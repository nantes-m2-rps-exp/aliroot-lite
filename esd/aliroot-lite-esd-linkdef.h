...
#pragma read sourceClass = "AliESDHeader" targetClass =                        \
    "AliESDHeader" source = "TObjArray fIRBufferArray" version =               \
        "[10-13]" target = "fIRBufferArray" targetType = "TObjArray" code =    \
...
#pragma read sourceClass = "AliESDCaloTrigger" targetClass =                                    \
    "AliESDCaloTrigger" source =                                                                \
        "Int_t fNEntries; Int_t * fColumn; Int_t * fRow; Char_t fTriggerBits[48][64]" version = \
            "[2]" target = "fTriggerBits" targetType = "Int_t*" code =                          \
...
#pragma read sourceClass = "AliESDtrack" targetClass = "AliESDtrack" source =  \
    "UChar_t fTRDpidQuality" version = "[-47]" target =                        \
        "fTRDntracklets" targetType = "UChar_t" code =                         \
            "{fTRDntracklets=onfile.fTRDpidQuality;}"
// see http://root.cern.ch/svn/root/trunk/io/doc/DataModelEvolution.txt

#pragma read sourceClass = "AliESDtrack" targetClass = "AliESDtrack" source =  \
    "Int_t fTOFLabel[3]" version = "[-68]" target = "fTOFLabel" targetType =   \
        "Int_t*" code =                                                        \
            "{fTOFLabel = new Int_t[3];for(Int_t i=0;i < 3;i++) fTOFLabel[i]=onfile.fTOFLabel[i];}"
#pragma read sourceClass = "AliESDtrack" targetClass = "AliESDtrack" source =  \
    "Double32_t fTrackTime[5]" version = "[-68]" target =                      \
        "fTrackTime" targetType = "Double32_t*" include = "AliPID.h" code =    \
...
#pragma read sourceClass = "AliESDtrack" targetClass = "AliESDtrack" source =  \
    "Double32_t fTrackLength" version = "[-68]" target =                       \
        "fTrackLength" targetType = "Double32_t" code =                        \
            "{fTrackLength=onfile.fTrackLength;}"

#pragma read sourceClass = "AliESDtrack" targetClass = "AliESDtrack" source =  \
    "Double32_t fTOFsignal" version = "[-68]" target =                         \
        "fTOFsignal" targetType = "Double32_t" code =                          \
            "{fTOFsignal=onfile.fTOFsignal;}"
#pragma read sourceClass = "AliESDtrack" targetClass = "AliESDtrack" source =  \
    "Double32_t fTOFsignalToT" version = "[-68]" target =                      \
        "fTOFsignalToT" targetType = "Double32_t" code =                       \
            "{fTOFsignalToT=onfile.fTOFsignalToT;}"
#pragma read sourceClass = "AliESDtrack" targetClass = "AliESDtrack" source =  \
    "Double32_t fTOFsignalRaw" version = "[-68]" target =                      \
        "fTOFsignalRaw" targetType = "Double32_t" code =                       \
            "{fTOFsignalRaw=onfile.fTOFsignalRaw;}"
#pragma read sourceClass = "AliESDtrack" targetClass = "AliESDtrack" source =  \
    "Double32_t fTOFsignalDx" version = "[-68]" target =                       \
        "fTOFsignalDx" targetType = "Double32_t" code =                        \
            "{fTOFsignalDx=onfile.fTOFsignalDx;}"
#pragma read sourceClass = "AliESDtrack" targetClass = "AliESDtrack" source =  \
    "Double32_t fTOFsignalDz" version = "[-68]" target =                       \
        "fTOFsignalDz" targetType = "Double32_t" code =                        \
            "{fTOFsignalDz=onfile.fTOFsignalDz;}"
#pragma read sourceClass = "AliESDtrack" targetClass = "AliESDtrack" source =  \
    "Short_t fTOFdeltaBC" version = "[-68]" target =                           \
        "fTOFdeltaBC" targetType = "Short_t" code =                            \
            "{fTOFdeltaBC=onfile.fTOFdeltaBC;}"
#pragma read sourceClass = "AliESDtrack" targetClass = "AliESDtrack" source =  \
    "Short_t fTOFl0l1" version = "[-68]" target = "fTOFl0l1" targetType =      \
        "Short_t" code = "{fTOFl0l1=onfile.fTOFl0l1;}"
#pragma read sourceClass = "AliESDtrack" targetClass = "AliESDtrack" source =  \
    "Int_t fTOFCalChannel" version = "[-68]" target =                          \
        "fTOFCalChannel" targetType = "Int_t" code =                           \
            "{fTOFCalChannel=onfile.fTOFCalChannel;}"

#pragma read sourceClass = "AliESDtrack" targetClass = "AliESDtrack" source =  \
    "Double32_t fR[5]" version = "[-70]" target = "fR" targetType =            \
        "Double32_t*" include = "AliPID.h" code =                              \
            "{fR = new Double32_t[AliPID::kSPECIES];for(Int_t isp=5;isp--;) fR[isp]=onfile.fR[isp];}"

#pragma read sourceClass = "AliESDtrack" targetClass = "AliESDtrack" source =  \
    "Double32_t fTPCr[5]" version = "[-70]" target = "fTPCr" targetType =      \
        "Double32_t*" include = "AliPID.h" code =                              \
            "{fTPCr = new Double32_t[AliPID::kSPECIES];for(Int_t isp=5;isp--;) fTPCr[isp]=onfile.fTPCr[isp];}"

#pragma read sourceClass = "AliESDtrack" targetClass = "AliESDtrack" source =  \
    "Double32_t fITSr[5]" version = "[-70]" target = "fITSr" targetType =      \
        "Double32_t*" include = "AliPID.h" code =                              \
            "{fITSr = new Double32_t[AliPID::kSPECIES];for(Int_t isp=5;isp--;) fITSr[isp]=onfile.fITSr[isp];}"

#pragma read sourceClass = "AliESDtrack" targetClass = "AliESDtrack" source =  \
    "Double32_t fTRDr[5]" version = "[-70]" target = "fTRDr" targetType =      \
        "Double32_t*" include = "AliPID.h" code =                              \
            "{fTRDr = new Double32_t[AliPID::kSPECIES];for(Int_t isp=5;isp--;) fTRDr[isp]=onfile.fTRDr[isp];}"

#pragma read sourceClass = "AliESDtrack" targetClass = "AliESDtrack" source =  \
    "Double32_t fTOFr[5]" version = "[-70]" target = "fTOFr" targetType =      \
        "Double32_t*" include = "AliPID.h" code =                              \
            "{fTOFr = new Double32_t[AliPID::kSPECIES];for(Int_t isp=5;isp--;) fTOFr[isp]=onfile.fTOFr[isp];}"

#pragma read sourceClass = "AliESDtrack" targetClass = "AliESDtrack" source =  \
    "Double32_t fHMPIDr[5]" version = "[-70]" target = "fHMPIDr" targetType =  \
        "Double32_t*" include = "AliPID.h" code =                              \
            "{fHMPIDr = new Double32_t[AliPID::kSPECIES];for(Int_t isp=5;isp--;) fHMPIDr[isp]=onfile.fHMPIDr[isp];}"

#pragma link C++ class AliESDtrack + ;
#pragma read sourceClass = "AliESDfriendTrack" targetClass =                   \
    "AliESDfriendTrack" source = "Int_t fITSindex" version = "[-3]" target =   \
        "fnMaxITScluster, fITSindex" targetType = "Int_t, Int_t*" code =       \
            "{fnMaxITScluster = 12; fITSindex= new Int_t[fnMaxITScluster]; memcpy(fITSindex, &(onfile.fITSindex), fnMaxITScluster*sizeof(Int_t));}"
#pragma read sourceClass = "AliESDfriendTrack" targetClass =                   \
    "AliESDfriendTrack" source = "Int_t fTPCindex" version = "[-3]" target =   \
        "fnMaxTPCcluster, fTPCindex" targetType = "Int_t, Int_t*" code =       \
            "{fnMaxTPCcluster = 160; fTPCindex= new Int_t[fnMaxTPCcluster]; memcpy(fTPCindex, &(onfile.fTPCindex), fnMaxTPCcluster*sizeof(Int_t));}"
#pragma read sourceClass = "AliESDfriendTrack" targetClass =                   \
    "AliESDfriendTrack" source = "Int_t fTRDindex" version = "[-3]" target =   \
        "fnMaxTRDcluster, fTRDindex" targetType = "Int_t, Int_t*" code =       \
...
#pragma read sourceClass = "AliESDTrdTracklet" targetClass =                   \
    "AliESDTrdTracklet" source = "Int_t fLabel" version = "[-2]" target =      \
        "fLabel" targetType = "Int_t[3]" code =                                \
            "{fLabel[0]=onfile.fLabel; fLabel[1]=fLabel[2]=-1;}"
...
#pragma read sourceClass = "AliESDFMD" targetClass = "AliESDFMD" source =      \
    "float fNoiseFactor" version = "[-3]" target = "fNoiseFactor" targetType = \
        "float" code =                                                         \
            "{newObj->SetNoiseFactor(onfile.fNoiseFactor < 1 ? 4 : onfile.fNoiseFactor);newObj->SetBit(AliESDFMD::kNeedNoiseFix);}"
#pragma read sourceClass = "AliESDFMD" targetClass = "AliESDFMD" source =      \
    "bool fAngleCorrected" version = "[-3]" target =                           \
        "fAngleCorrected" targetType = "bool" code =                           \
...
#pragma link C++ function AliESDUtils::GetCorrV0(const AliESDEvent *,          \
                                                 Float_t &);
