...
public:
  AliESDCosmicTrack();
  AliESDCosmicTrack(const Int_t idUp, const Int_t idLow,
                    const AliExternalTrackParam *trkparUp,
                    const AliExternalTrackParam *trkparLow,
                    const AliExternalTrackParam *parx0Up,
                    const AliExternalTrackParam *parx0Low, const Int_t ncls,
                    const Double_t la, const Double_t chi2, const Double_t vd,
                    const Double_t vz, const Bool_t isreuse,
                    const Double_t findable, const TVector3 innerclusterupper,
                    const TVector3 innerclusterlower);
...
private:
  AliExternalTrackParam
      *fLowerTrackParam; // trackparameter estimated at lower-outer part of TPC
  ...
  Int_t fESDtrackIndex[2]; //[0]= ESD track for this object; [1]= ESD track for
                           //LowerTrackParma
  ...
  Bool_t fIsReuse; // true if one of the track from the pair already used in
                   // previous pair
  Double_t fFindableRatio; // min of TPC ncls/nfindablecls of the two tracks

  ClassDef(AliESDCosmicTrack,
           1); // 0: only data members derived from AliExternalTrackParam are
               // saved in tree; 1: all are saved!!
};
